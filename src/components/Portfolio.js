...
import screenshot42 from "./images/Screenshot42.png";
function Portfolio() {
    return (
        <main>
            <div className="container box-2 containerDiv mx-auto">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="card" style={{ width: "18rem", border: "2px solid teal", borderRadius: "15px" }}>
                            <img src={screenshot42} style={{ borderRadius: "15px 15px 0 0" }} width="200" height="200" className="card-img-top" alt="application" />

                            <div className="card-body">
                                <h5 className="card-title">Fire Sprinkler</h5>
                                <p className="card-text">Use HTML5, CSS3 and Bootstrap framework to build a responsive simple read website about fire sprinkler company that is located in New Jersey. It can be added more features.</p>
                            </div>

                            <div className="card-body">
                                <a href={"https://ddavidson202020.github.io/Fire_Sprinkler/"} target="_blank" rel="noopener noreferrer" className="card-link" style={{ color: "rgb(238, 178, 12)", fontWeight: "bold" }}>Live Site</a>
                                <a href={"https://github.com/DDavidson202020/Fire_Sprinkler"} target="_blank" rel="noopener noreferrer" className="card-link" style={{ color: "hotpink", fontWeight: "bold" }}>Github Repo</a>
                            </div>
                        </div>
